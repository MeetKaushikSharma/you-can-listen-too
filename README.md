...
> 🎥 **Before installing, watch the complete installation & setup tutorial:**
> **https://drive.google.com/file/d/1fvb9cVIUkvwGGgpChsVo7wluaeX0JIv5/view?usp=sharing**

---

## 🎥 Installation & Setup Tutorial (Highly Recommended)

> **⚠️ Please watch the video before installing the application.**
...
* ✅ Connecting multiple Bluetooth/USB headphones
...
3. **Configure the App:**
   ...
   * Enable the checkboxes for your connected headphones and select their respective output devices.
4. **Start Listening:**

   * Click **START ROUTING**.
   * Adjust individual volume levels and delay sliders to perfectly synchronize audio.
